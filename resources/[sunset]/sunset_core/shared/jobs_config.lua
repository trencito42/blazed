...
Sunset.JobsConfig = {
    trucker = {
        ...
        -- Delivery categories: convenience, fuel, restaurant, industrial.
        -- All routes available from rank 1; rank bonus applies to final pay.
        routes = {
            -- ── Convenience (24/7 stores) ─────────────────────────────────
            { category = 'convenience', pay = 600,
              pickup   = vector3(892.15, -3204.55, 5.90),
              delivery = vector3(-706.0, -913.0, 19.2),
              label    = 'Terminal → Mirror Park 24/7' },
            { category = 'convenience', pay = 620,
              pickup   = vector3(-424.88, -2789.33, 6.0),
              delivery = vector3(2673.27, 3513.14, 52.71),
              label    = 'Docks → Harmony 24/7' },
            { category = 'convenience', pay = 640,
              pickup   = vector3(892.15, -3204.55, 5.90),
              delivery = vector3(543.69, 2679.89, 42.16),
              label    = 'Terminal → Sandy Shores 24/7' },

            -- ── Fuel (Gas Stations · Phantom + tanker) ───────────────────
            { category = 'fuel', pay = 680,
              pickup   = vector3(-424.88, -2789.33, 6.0),
              delivery = vector3(1181.2, 2671.5, 37.9),
              label    = 'Docks → Sandy Shores Gas Station' },
            ...
            { category = 'fuel', pay = 700,
              ...
              label    = 'Terminal → West Eclipse Gas Station' },
            ...
            { category = 'restaurant', pay = 850,
              pickup   = vector3(-424.88, -2789.33, 6.0),
              delivery = vector3(-1193.26, -1475.47, 4.36),
              label    = 'Docks → Vespucci Beachside Café' },
            ...
            { category = 'industrial', pay = 1000,
              pickup   = vector3(892.15, -3204.55, 5.90),
              delivery = vector3(-448.69, 6010.07, 31.55),
              label    = 'Terminal → Paleto Bay Industrial' },
        },
        xpPerDelivery = 45,
        timeoutSec = 1800,
        deliveryRadius = 25.0,
