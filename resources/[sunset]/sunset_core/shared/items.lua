...
Sunset.Items = {
    water = { label = 'Water Bottle', weight = 0.2, usable = true, hunger = 0, thirst = 25, category = 'drinks', icon = '💧' },
    bread = { label = 'Bread', weight = 0.2, usable = true, hunger = 20, thirst = 0, category = 'food', icon = '🍞' },
    burger = { label = 'Burger', weight = 0.3, usable = true, hunger = 35, thirst = -5, category = 'food', icon = '🍔' },
    phone = { label = 'Phone', weight = 0.1, usable = false, category = 'misc', icon = '📱' },
    id_card = { label = 'ID Card', weight = 0.05, usable = false, category = 'misc', icon = '🪪' },
    driver_license = { label = 'Driver License', weight = 0.05, usable = false, category = 'misc', icon = '🪪' },
    repairkit = { label = 'Repair Kit', weight = 2.0, usable = true, category = 'tools', icon = '🔧' },
    bandage = { label = 'Bandage', weight = 0.1, usable = true, heal = 25, category = 'medical', icon = '🩹' },
    cigarette = { label = 'Cigarette', weight = 0.05, usable = true, stress = -10, category = 'supplies', icon = '🚬' },
    lockpick = { label = 'Lockpick', weight = 0.2, usable = true, category = 'tools', icon = '🔑' },
    metal_scrap = { label = 'Metal Scrap', weight = 0.5, usable = false, category = 'materials', icon = '⚙️' },
    plastic = { label = 'Plastic', weight = 0.15, usable = false, category = 'materials', icon = '🧴' },
    cloth = { label = 'Cloth', weight = 0.1, usable = false, category = 'materials', icon = '🧵' },
    chemicals = { label = 'Chemicals', weight = 0.3, usable = false, category = 'materials', icon = '🧪' },
    gunpowder = { label = 'Gunpowder', weight = 0.2, usable = false, category = 'ammo', icon = '💥' },
