...
Sunset.HelpAdminDescriptions = {
    ...
    arespawn = 'Respawn a player at their saved spawn menu choice (home / last / default / HQ)',
...
Sunset.HelpGeneralEntries = {
    ...
    { cmd = 'Z / /proximity', desc = 'Cycle voice chat range (Whisper: 1.5m, Normal: 4.0m, Shout: 10.0m)' },
