...
Sunset.HelpAdminDescriptions = {
    ...
    arespawn = 'Respawn a player at their saved spawn choice (home / HQ / default)',
    noclip = 'Toggle noclip mode',
    god = 'Toggle god mode',
    cc = 'Clear the chat for every player',
    ...
    dl = 'Toggle SA-MP-style vehicle debug labels: entity/net ID, model, plate, speed, health and network owner',
    ...
    spy = 'Toggle faction chat spy (/f, /r, /d) for moderators+',
    ...
    setsc = 'Set Blaze Points for a player: /setsc [id] [amount]',
...
Sunset.HelpGeneralEntries = {
    ...
    { cmd = '/accepttrade', desc = 'Accept the pending nearby inventory trade request' },
    { cmd = '/declinetrade', desc = 'Decline the pending inventory trade request' },
    ...
    { cmd = '/issuelicense [id] [pilot|boat|weapon]', desc = 'On-duty LSSI instructor: authorize a nearby candidate at the correct exam facility' },
    { cmd = '/v', desc = 'Personal vehicles — spawn, GPS, park, or store' },
    { cmd = '/garage', desc = 'Garage panel' },
    { cmd = '/park', desc = 'While driving your personal vehicle, save its current world position' },
    { cmd = '[E] LS Customs', desc = 'In your vehicle at LS Customs HQ — repair ($250) or ECU tuning' },
    { cmd = '/dealership', desc = 'Browse vehicles at Premium Deluxe Motorsport' },
    { cmd = '2', desc = 'Start or stop the vehicle engine manually' },
    { cmd = 'U / /lock', desc = 'Lock or unlock your vehicle doors' },
    ...
    { cmd = '/pass', desc = 'Open Blaze Pass rewards track' },
    { cmd = '/missions', desc = 'Open Blaze Pass missions' },
    ...
    { cmd = '/group', desc = 'Same as /clan — clan unit panel' },
    { cmd = '/clans', desc = 'Browse all player-created clans on the server' },
    { cmd = '/c [message]', desc = 'Clan chat — only your clan members see it (shows rank + title)' },
    { cmd = '/cmotd [message?]', desc = 'Read clan MOTD; officers may set it' },
...
Sunset.CommandUsage = {
    ...
    f = { usage = '/f [message]', minArgs = 1 },
    r = { usage = '/r [message]', minArgs = 1 },
    ...
    finvite = { usage = '/finvite [server id]', minArgs = 1 },
    acceptfaction = { usage = '/acceptfaction', minArgs = 0 },
    declinefaction = { usage = '/declinefaction', minArgs = 0 },
...
for _, name in ipairs({
    ...
    'fgiverank', 'funinvite', 'fwarn', 'fmotd', 'fmembers', 'cmotd', 'sellpouch', 'fence',
    'pd', 'fd', 'pdgarage', 'su', 'so', 'clear', 'unjail', 'wanted', 'find', 'arrest',
    'booking', 'backup', 'cbackup', 'mdc', 'ticket', 'confiscate', 'radars', 'startradar', 'setradar', 'radar', 'stopradar',
